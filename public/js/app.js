...
/* harmony import */ var _classes_Errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../classes/Errors */ "./resources/js/classes/Errors.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      errors: new _classes_Errors__WEBPACK_IMPORTED_MODULE_0__["default"](),
      body: '',
      post: {},
      comments: []
    };
  ...
  methods: {
    ...
    createComment: function createComment(e) {
      ...
      axios.post(e.target.action, {
        ...
        if (xhr.response.status === 401 && xhr.response.data.error === 'Unauthenticated.') {
          window.location.href = window.location.origin + '/login';
        }

        if (xhr.response.data.errors) {
          vm.errors = new _classes_Errors__WEBPACK_IMPORTED_MODULE_0__["default"](xhr.response.data.errors);
        }
      });
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.errors = new _classes_Errors__WEBPACK_IMPORTED_MODULE_0__["default"](this.initialErrors);
  },
  methods: {
    add: function add() {
          ...
          _c("div", { staticClass: "media-content" }, [
            _c("div", { staticClass: "content" }, [
              _c("p", [
                ...
                _vm._v(" "),
                _c("small", [_vm._v(_vm._s(comment.short_timestamp))]),
                _vm._v(" "),
                _c("br"),
                _vm._v(
                  "\n                    " +
            ...
            _c("nav", { staticClass: "level is-mobile" }, [
              _c("div", { staticClass: "level-left" }, [
                  ...
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.toggleComment(index)
                      }
                    }
                  },
                  [_vm._m(1, true)]
                ...
                _c(
                  "form",
                  {
                    attrs: { method: "post", action: "/comment/" + comment.id }
                  },
                  [
                    _c(
                      "button",
                      ...
                      [
                        _vm._m(2, true),
                        _c("span", [_vm._v(_vm._s(comment.favourites_count))])
                      ]
                    )
                  ]
                )
            ...
            _c(
              "form",
              {
                class: [comment.is_active ? "" : "is-hidden", "media"],
                attrs: {
                  action:
                    "/post/" +
                    _vm.post.slug +
    ...
    [
      _c(
        "label",
        {
          ...
          class: { "border-red-500": _vm.errors.has("tags") },
          attrs: { for: "tags" }
        },
        [_vm._v("Tags")]
      ),
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            {
              staticClass:
                "flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white px-2 rounded outline-none",
              attrs: { type: "button" },
              on: { click: _vm.add }
            },
            [_vm._v("Add")]
      ...
      _c(
        ...
        _vm._l(_vm.tags, function(tag) {
          return _c(
            ...
            {
              staticClass:
                "mr-2 bg-gray-100 rounded-full px-3 py-1 text-xs text-gray-600 mr-2 hover:text-black hover:underline"
            },
            [_vm._v(_vm._s("#" + tag))]
          )
        }),
      ...
      _vm.errors.has("tags")
        ? _c("p", { staticClass: "text-red-500 text-xs italic" }, [
            _vm._v(_vm._s(_vm.errors.first("tags")))
          ])
        : _vm._e()
    ],
    2
...
Vue.component('tags', __webpack_require__(/*! ./components/Tags.vue */ "./resources/js/components/Tags.vue")["default"]);
var app = new Vue({
  el: '#app'
});
...
__webpack_require__(/*! /Users/pat/code/laravel-profile/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/pat/code/laravel-profile/resources/css/app.css */"./resources/css/app.css");
