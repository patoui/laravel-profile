...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        createComment: function createComment(e) {
            e.preventDefault();
            var vm = this;
            axios.post(e.target.action, { body: this.body }).then(function (response) {
                // handle success
                console.log('Success');
            }).catch(function (xhr) {
                ...
                if (xhr.response.data.errors) {
                    vm.errors = new __WEBPACK_IMPORTED_MODULE_0__classes_Errors__["a" /* default */](xhr.response.data.errors);
                }
            });
        }
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.errors = new __WEBPACK_IMPORTED_MODULE_0__classes_Errors__["a" /* default */](this.initialErrors);
    },
            ...
            comment.comments
              ? _c(
                  ...
                  [
                    _c("comments", {
                      attrs: {
                        "initial-post": _vm.initialPost,
                        "initial-comments": comment.comments
                      }
                    })
                  ],
                  1
        ...
        [
          _c("div", { staticClass: "navbar-end" }, [
            _vm.isAuthed()
              ...
              : _vm._e(),
            _vm._v(" "),
            _c("a", { staticClass: "navbar-item ", attrs: { href: "/tip" } }, [
              _vm._v("Tips")
            ]),
            _vm._v(" "),
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "field has-addons" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "control" }, [
          _c("a", { staticClass: "button", on: { click: _vm.add } }, [
            _vm._v("Add")
          ])
        ])
      ]),
