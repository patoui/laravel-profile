...
<div class="mb-4">
    ...
    <div class="flex items-center border-b border-b-2 border-teal-500 py-2">
        ...
        <button class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white px-2 rounded outline-none" type="button" @click="add">Add</button>
    </div>
