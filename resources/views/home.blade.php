...
<p class="block mb-5 leading-relaxed">I'm a developer who currently works with: PHP (Laravel), JavaScript (VueJS, ReactJS), and CSS. I have an obsession with learning, whether it’s to sharpen my existing skills or to explore new ones such as: Go, Elixir, Ruby (Ruby on Rails), Python (Django), React, etc. I also enjoy running, hiking, biking, weight lifting, soccer, and basketball.</p>
<p class="block mb-5 leading-relaxed">I’ve decided to try myself at blogging to share some tips and tricks I’ve learned during my time as a developer, whether they be technical, interpersonal, or otherwise; my hope is that fellow developers may learn something from my blog.</p>
